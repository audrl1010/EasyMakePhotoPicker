...
class KaKaoChatVC: BaseVC {
  ...
  lazy var tableView: UITableView = { [unowned self] in
    ...
    tv.register(KaKaoChatCell.self,
      forCellReuseIdentifier: KaKaoChatCell.cellIdentifier)
    return tv
  }()
  
  var photosViewConfigure = KaKaoChatPhotosViewConfigure()
...
extension KaKaoChatVC: UITableViewDataSource {
  ...
  func tableView(
    ...
    let cell =
      tableView.dequeueReusableCell(
        withIdentifier: KaKaoChatCell.cellIdentifier,
        for: indexPath) as! KaKaoChatCell
...
extension KaKaoChatVC: KeyboardObservable {
...
extension KaKaoChatVC: keyboardDismissableByViewTouch {
